...
header = ["Name", "Cation_formula", "Num_Atom_Types", "Num_Atoms", "Atom_Types", "Bandgap_GGA_(eV)", 
          "Dielectric_Constant_electronic", "Dielectric_constant_ionic", "Dielectric_constant_total", 
          "Refractive_index", "Atomization_Energy(eV/atom)", "Relative_energy1(eV/atom)", "Relative energy2(eV/atom)", 
          "Unit_cell_volume_(A^3)", "Density_(g/cm^3)", "Tool", "Pseudopotential", "Note"]
